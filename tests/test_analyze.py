...
class AttachmentSemanticAnalysisTests(unittest.TestCase):
    ...
    def test_spreadsheet_ready_outputs_are_complete(self) -> None:
        ...
        self.assertEqual(len(self.analysis["questionInventory"]), 197)
        self.assertEqual(len(self.analysis["formQuestionWorkbook"]), 1277)
        self.assertEqual(len(self.analysis["pairwiseExploratory"]), 630)
        self.assertEqual(len(self.analysis["marginalCapabilityReuse"]), 36)
    ...
    def test_unreviewed_semantics_never_enter_published_metrics(self) -> None:
        ...
        self.assertEqual(self.analysis["status"]["exploratoryAssociationCount"], 1277)
        self.assertTrue(
