...
- Infrastructure PR #59 merged as `c7a3a9e9da217131bc38a9b1bc7d57d3a273796d`. PR #58 was rebased over it and all three overlapping test-file edits were dropped. Its final delta is limited to portable artifacts and exact XSD fixtures; the local classifier reports `bankOnly=true`, two added forms, 36 selected forms, and 418 artifacts. Hosted lightweight CI and independent review remain required before merge.
