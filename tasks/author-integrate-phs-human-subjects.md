...
priority: P1
description: >-
  Establish the dimensional clinical-study foundation for deep conditions,
  nested repetition, enrollment, and HHS research behavior.
...
- Its source-bound runtime package has thirteen working conditions, eleven repetitions, a 115-cell dimensional enrollment model, and one unresolved calculation decision.
