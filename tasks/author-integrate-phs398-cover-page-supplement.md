...
- The research factory records 38 source question/structure records, 37 behavior records, eight proposed components, and twenty-two working conditions.
- Two-year usage evidence records 232,136 form instances.
...
- Express all source-backed conditions and any calculations declaratively.
- Validate conditional branches, organization/investigator context, attachments, save/reload, locked/print, XML/XSD, submission, and accessibility.
...
Record which HHS policy-profile mechanisms can support Fellowship Supplemental without creating a general policy DSL.
