...
Implemented and pushed as consumer commit `5c70d1729` in fork-only stacked PR [#74](https://github.com/mikec-ai/simpler-grants-gov/pull/74), based on `codex/sf424-compatibility-receipt`.
...
Ordinary SF-424 behavior remains 66 UI fields and 66 editable declarations. Focused evidence: 11 browser-plan tests passed; focused Black/isort formatting, Ruff lint, and mypy passed. No Docker, API, or browser environment was run or mutated.
